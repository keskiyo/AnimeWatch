...
//  и сортировка не должна быть только по первым 12 загруженным, должны запрашиваться аниме с 1980-сегодняшную дату а по всем что есть на shikimori и убери  [character=186854]Химмеля[/character] оставляй только Химмеля и [character=184947]Фрирен[/character] тут Фрирен
