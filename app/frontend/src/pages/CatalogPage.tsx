	...
	return (
		<main className='mx-auto max-w-345 px-4 py-6.5 pb-10'>
			<div className='mb-3 hidden justify-end max-[1024px]:flex'>
				<button
					type='button'
					className='inline-flex items-center gap-2 rounded-md border border-aw-border bg-aw-surface px-3 py-2 text-aw-text transition-colors hover:bg-aw-elevated'
